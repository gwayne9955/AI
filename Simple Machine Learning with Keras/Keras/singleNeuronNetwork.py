...
model.fit(training_set_inputs, training_set_outputs, epochs=10, batch_size=4)
...
# !!! Should print 0, or whichever value (0 or 1) is the left-most value in the
# validating test array !!!
